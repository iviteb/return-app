...
class OrderDetails extends Component<any, any> {
  ...
  constructor(props: any) {
    ...
    this.automaticWeightDistribution =
      this.automaticWeightDistribution.bind(this)
  ...
  validateParcelsWeight() {
    const { parcelWeights, totalWeight, parcelWeightsErrors, numberOfParcels } =
      this.state
  ...
  automaticWeightDistribution() {
    const { totalWeight, numberOfParcels, parcelWeights, quantityWeights } =
      this.state
  ...
  getAWBHistory() {
    ...
    const reverseCourier = Object.assign(
      {},
      ...Object.entries(carriers).map(([a, b]) => ({ [b as any]: a }))
    )
      ...
      return (
        <div className={`pa6 ${styles.flex05}`}>
          ...
          >
              ...
              <Card>
                <div className={`flex flex-row ${styles.flex1}`}>
                      ...
                      {order.items.map((item, i) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <div
                              className={`flex flex-column ${styles.flex08}`}
                            >
                              <span
                                className={`${styles.productInfo} ${styles.bold} ${styles.font14}`}
                              >
                              ...
                              <span
                                className={`${styles.productInfo} ${styles.font14}`}
                              >
                                {item.name}
                              </span>
                              <span
                  ...
                  <div className={`flex flex-column ${styles.flex05}`}>
                    <span
                      className={`${styles.shippingInfoTitle} ${styles.bold} ${styles.font14}`}
                    >
                      {formatMessage({ id: messages.shippingInformation.id })}
                    </span>
                    <span
                      className={`${styles.shippingInfoText} ${styles.font14}`}
                    >
            ...
            <h4 className="mt7">
              {formatMessage({ id: messages.shippingStatus.id })}
            </h4>
